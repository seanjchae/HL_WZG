...
def Loop(cha,process):
	
	infile = '/u/user/yeobi97/SE_UserHome/fin_WZG_nTuple/'+cha+'_'+process+'_updated_nTuple.npy'
	...
	try :
		...
		#photon_pt = arrays['photon_pt' ]
		#photon_eta = arrays['photon_eta']
		#photon_phi = arrays['photon_phi']
