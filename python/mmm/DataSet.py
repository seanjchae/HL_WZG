...
infile = '/u/user/yeobi97/JKPS_WZG/WZG/eta_phi_ML/preprocess/SM_make/df_shuffle_out/mmm_binary.h5'
...
test_df = test_df.reset_index(drop=True)
test_df.to_hdf('mmm_testset.h5', key = 'df', mode = 'w')

train_df = train_df.reset_index(drop=True)
train_df.to_hdf('mmm_trainset.h5', key = 'df', mode = 'w')

#jiwan added to get validation set
val_df = val_df.reset_index(drop=True)
val_df.to_hdf('mmm_valiset.h5', key ='df', mode ='w')
