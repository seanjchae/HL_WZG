...
infile = '/u/user/yeobi97/JKPS_WZG/WZG/eta_phi_ML/preprocess/SM_make/df_shuffle_out/eee_binary.h5'
...
train_df.to_hdf('eee_trainset.h5', key = 'df', mode = 'w')

#jiwan added to get validation set
val_df = val_df.reset_index(drop=True)
val_df.to_hdf('eee_valiset.h5', key ='df', mode ='w')
