...
parser.add_argument('--channel', type=str, default='mmm', help="--channel CHANNEL")
...
#jiwan added for evaluating with train set

sys.path.append("/u/user/yeobi97/JKPS_WZG/WZG/final_trial/python/mmm")
...
#for Adam
#model.load_state_dict(torch.load('/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/Train/mmm_weightFile_Adam_b8192_n2048.pth'))

#optm = optim.Adam(model.parameters(), lr=LR)

#for Adagrad
model.load_state_dict(torch.load('/u/user/yeobi97/JKPS_WZG/WZG/final_trial/run/Train/mmm_weightFile.pth'))

optm = optim.Adagrad(model.parameters(), lr=LR)

#for RMSprop
#model.load_state_dict(torch.load('/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/Train/mmm_weightFile_RMSPROP_b8192_n2048.pth'))
...
#for Adam
#predFile = 'mmm_prediction_Adam.csv'

#for Adagrad/RMSPROP
predFile = 'TrainSET_mmm_prediction_Adagrad.csv'
