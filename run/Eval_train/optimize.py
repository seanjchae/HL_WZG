...
SF = [47.00754082769998,33.70842176592875,30.622273448279365,52.39384884835617]
...
def infile(cha):
	...
	infile = '/u/user/yeobi97/JKPS_WZG/WZG/final_trial/run/Eval_train/TrainSET_'+cha+'_prediction_Adagrad.csv'

#	infile = '/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/Eval_train/'+cha+'_prediction_Adagrad.csv'
...
###############################################################################################
	...
	plt.yscale('log')
	plt.savefig("{0}_Adagrad_Nor_DNN_score_b100.png".format(cha))
	plt.show()
	plt.close()
