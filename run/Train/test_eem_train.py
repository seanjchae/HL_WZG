...
##  Data load
# jiwan added : for only eem channel training
sys.path.append("/u/user/yeobi97/JKPS_WZG/WZG/eta_phi_ML/python/eem")
...
try:
    ...
    for epoch in range(1, EPOCH + 1):
        ...
        if bestLoss > val_loss:
            ...
            torch.save(bestWeight, 'eem_weightFile.pth')
        ...
        with open('eem_history.csv', 'w') as f:
            writer = csv.writer(f)
            keys = history.keys()
