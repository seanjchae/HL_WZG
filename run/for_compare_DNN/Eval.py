...
#jiwan added for evaluating with validation set

#sys.path.append("/u/user/yeobi97/JKPS_WZG/WZG/ML_jiwan/python/eee/")
...
#jiwan added for train-evaluate DNN score comparison : DNN score from training process
...
#for Adagrad
model.load_state_dict(torch.load('/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/Train/eee_weightFile_Adagrad_b8192_n2048.pth'))
...
#for Adagrad/RMSPROP
predFile = 'eee_prediction_Train_Adagrad.csv'
