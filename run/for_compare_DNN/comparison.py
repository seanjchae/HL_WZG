...
train_result = '/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/for_compare_DNN/eee_prediction_Train_Adagrad.csv'
eval_result = '/u/user/yeobi97/JKPS_WZG/WZG/ML_finalized/opte_run/Eval_norm/eee_prediction_Adagrad.csv'	
...
plt.yscale('log')
plt.savefig('DNNscore_comparison')
plt.show()
plt.close()
